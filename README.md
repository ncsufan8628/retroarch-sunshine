...
The image defaults `SUNSHINE_CAPTURE=x11` so Sunshine does not probe PipeWire/portal capture inside the container. To test NVIDIA Frame Buffer Capture instead, set `SUNSHINE_CAPTURE=nvfbc`.
